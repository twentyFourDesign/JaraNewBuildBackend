...
const diningExperienceRoute = require("./diningExperience.router");
const daypassExtensionRoute = require("./daypassExtension.router");
...
allRoutes.use("/diningExperience", diningExperienceRoute);
allRoutes.use("/daypassExtension", daypassExtensionRoute);
